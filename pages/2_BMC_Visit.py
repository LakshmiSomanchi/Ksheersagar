...
with st.form(key='bmc_visit_form'):
    ...
    with col2:
        ...
        if district_option == t('others'):
            other_district_input = st.text_input(t('other_district_label'), key="other_district_input")
        ...
        if sub_district_option == t('others'):
            other_sub_district_input = st.text_input(t('other_sub_district_label'), key="other_sub_district_input")
    ...
    with col3:
        ...
        if education == t('others'):
            other_education = st.text_input(t('other_education_label'), key="other_education_input")
    ...
    with col_new_infra4:
        ...
        other_awareness_poster = None
        if t('others') in awareness_poster:
            other_awareness_poster = st.text_input(t('other_awareness_poster_label'), key="other_awareness_poster_input")
    ...
    with col9:
        ...
        if t('others') in cattle_feed_brand_name:
            other_cattle_feed_brand_name = st.text_input(t('other_cattle_feed_brand_label'), key="other_cattle_feed_brand_name_input")
