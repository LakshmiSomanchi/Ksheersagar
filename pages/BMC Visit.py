...
# --- Heritage Specific Data (Fixed Syntax Errors) ---
...
initial_values_defaults = {
    ...
    'vlcc_name_specify': '', # NEW: Specific field for 'Other (Specify)' VLCC Name
    'hpc_code': '',
    'types': "HPC",
    'farmer_name': FARMER_NAMES_WITH_OTHER[0] if FARMER_NAMES_WITH_OTHER else None,
    'other_farmer_name_specify': '', # Existing field for 'Other (Specify)' farmer name
    ...
    'pellet_feed': "Yes",
    'pellet_feed_brands': [],
    'pellet_feed_brands_specify': '', # NEW: Specific field for 'Other (Specify)' Pellet Brand
    'mineral_mixture': "Yes",
    'mineral_brand': MINERAL_MIXTURE_BRANDS[0] if MINERAL_MIXTURE_BRANDS else None,
    'mineral_brand_specify': '', # NEW: Specific field for 'Other (Specify)' Mineral Brand
    'mineral_qty': 0.0,
    'silage': "Yes",
    'silage_source': '',
    'silage_qty': 0.0,
    'water_sources': [],
    'water_sources_specify': '', # NEW: Specific field for 'Other (Specify)' Water Source
    'surveyor_name': SURVEYOR_NAMES[0] if SURVEYOR_NAMES else None,
    'surveyor_name_specify': '', # NEW: Specific field for 'Other (Specify)' Surveyor Name
...
def save_draft():
    ...
    # Collect only keys defined in initial_values_defaults, plus specific specify fields
